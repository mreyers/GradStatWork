...
Since this experiment is based on two different blocking variables, and each blocking variable represents a random effect, the experiment designers implemented a Latin Block Design to control for as much of the random effects as possible. 
