...
test_model <- gbm(data = prostate_train, lpsa ~ ., distribution = 'gaussian',
                  n.trees = 15, shrinkage = 0.3, bag.fraction = 0.8, interaction.depth = 2)
true_test_err <- mean((prostate_test$lpsa - predict(test_model, prostate_test, n.trees = 15))^2)
...
test_model_2 <- gbm(data = prostate_train, lpsa ~ ., distribution = 'gaussian',
                  n.trees = 741, shrinkage = 0.01, bag.fraction = 0.9, interaction.depth = 6)
true_test_err_2 <- mean((prostate_test$lpsa - predict(test_model_2, prostate_test, n.trees = 741))^2)
